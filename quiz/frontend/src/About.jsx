  ...
  return (
    <div className="bg-white rounded-3xl shadow-xl p-6 transform hover:scale-105 transition-transform text-center">
      <img
        src={member.image}
        alt={member.name}
        className="w-32 h-32 object-cover rounded-full border-4 border-indigo-500 shadow mx-auto mb-4 transform hover:scale-110 transition-transform"
      />
      ...
      <div className="flex justify-center gap-4 text-xl text-white">
        {Boolean(member?.links?.facebook?.trim()) && (
          <a
            ...
            className="bg-blue-600 hover:bg-blue-700 p-2 rounded-full hover:scale-110 transition-transform"
            target="_blank"
        ...
        {Boolean(member?.links?.linkedin?.trim()) && (
          <a
            ...
            className="bg-blue-500 hover:bg-blue-600 p-2 rounded-full hover:scale-110 transition-transform"
            target="_blank"
            rel="noopener noreferrer"
          >
            <FaLinkedinIn />
        ...
        {Boolean(member?.links?.website?.trim()) && (
          <a
            ...
            className="bg-green-600 hover:bg-green-700 p-2 rounded-full hover:scale-110 transition-transform"
            target="_blank"
            rel="noopener noreferrer"
          >
            <FaGlobe />
        ...
        {Boolean(member?.links?.github?.trim()) && (
          <a
            ...
            className="bg-gray-800 hover:bg-gray-900 p-2 rounded-full hover:scale-110 transition-transform"
            target="_blank"
            rel="noopener noreferrer"
          >
            <FaGithub />
