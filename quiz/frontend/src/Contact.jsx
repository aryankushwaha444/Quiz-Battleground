  ...
  return (
    <div className="bg-white rounded-3xl shadow-xl p-6 transform hover:scale-105 transition-transform text-center">
      ...
      <div className="flex justify-center gap-4 text-xl text-white">
        <a href={member.links.facebook} className="bg-blue-600 hover:bg-blue-700 p-2 rounded-full hover:scale-130 transition-transform" target="_blank" rel="noopener noreferrer">
          <FaFacebookF />
        </a>
        <a href={member.links.linkedin} className="bg-blue-500 hover:bg-blue-600 p-2 rounded-full hover:scale-130 transition-transform" target="_blank" rel="noopener noreferrer">
          <FaLinkedinIn />
        </a>
        <a href={member.links.website} className="bg-green-600 hover:bg-green-700 p-2 rounded-full hover:scale-130 transition-transform" target="_blank" rel="noopener noreferrer">
          <FaGlobe />
        </a>
        <a href={member.links.github} className="bg-gray-800 hover:bg-gray-900 p-2 rounded-full hover:scale-130 transition-transform" target="_blank" rel="noopener noreferrer">
          <FaGithub />
        </a>
      </div>
    </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#74ebd5] via-[#acb6e5] to-[#ffffff] flex items-center justify-center px-4">
      <div className="bg-purple-100 rounded-3xl shadow-2xl px-6 py-8 w-full max-w-6xl">
        <h1 className="text-4xl font-bold text-center text-blue-500 mb-10">Our Team</h1>
