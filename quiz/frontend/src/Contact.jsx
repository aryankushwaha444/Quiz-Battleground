      ...
      <div className="bg-purple-100 rounded-3xl shadow-2xl flex flex-col justify-center px-4 py-5 mt-18 mb-18">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-6 max-w-4xl mx-auto mb-12 transform hover:scale-105 transition-transform">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
            ...
            <div className="flex-1 text-center md:text-left">
              <h2 className="text-2xl font-bold text-indigo-800 mb-1 transform hover:scale-120 transition-transform">
                Aryan Kushwaha
              </h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto ">
          <div className="bg-white rounded-2xl shadow p-6 text-center transform hover:scale-105 transition-transform">
            ...
            />
            <h3 className="text-xl font-semibold mt-4 text-purple-700 transform hover:scale-120 transition-transform">
              Arabin Shrestha
            </h3>
